...
public abstract class TileEntityInventory extends TileEntity implements ITileInventry, ISidedInventory, INamedContainerProvider, INameable {
    public NonNullList<ItemStack> inventory;
    protected ITextComponent name;

    public TileEntityInventory(TileEntityType<?> tileEntityTypeIn,int sizeInventry){
        super(tileEntityTypeIn);
        inventory=NonNullList.withSize(sizeInventry, ItemStack.EMPTY);
